...
MatchResult SemanticMatcher::findBestMatch(const std::string& input_text) {
    MatchResult result;
...
std::vector<MatchResult> SemanticMatcher::findAllMatches(const std::string& input_text, int top_k) {
